                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <ul class="gallery-inner">
                            <!-- Image 1 -->
                            <li>
                                <a href="assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-1b.jpg" data-lightbox="example-set">
                            ...
                            <li>
                                <a href="assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-5b.jpg" data-lightbox="example-set">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="project-description">
                            <p>A belsőépítészeti tervek alapján készült Duna-parti galériás  lakás tulajdonosa azzal bízott meg hogy egy igényesen kialakított, Airbnb-n is kiadható lakást tervezzünk neki.</p>
                            <p>Teljes felújítást végeztünk.</p>
                            <p>A nappaliba a cégünk által képviselt DOMKAPA kárpitos bútorok kerültek, speciális, könnyen tisztítható anyaggal behúzva.</p>
                            <p>Az impozáns belmagasság kihangsúlyozására a CASAMANCE posztertapétáját használtuk, és ezzel összhangban hasonló színárnyalatokat a kapcsolódó helységekben is.</p>
                            
                            <p>A fürdőszobában az olasz V&Co burkolatai kerültek.</p>
                            
                            <p>Az árnyékolók a francia HOULES cég anyagaiból  és díszítő szalagjainak felhasználásával készültek.</p>
                        </div>
                    </div>
