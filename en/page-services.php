    ...
    <div class="container text-center padding-bottom">
            ...
            <div class="col-sm-4 col-md-4">
                ...
                <!-- Title -->
                    ...
                    <div class="service-title">
                        <h3><a href="http://www.lafenice.hu/designbutorcsomagok/en/" target="_blank">Design Furniture Packages</a></h3>
                    </div>
                </a>
        ...
        <div class="row padding-top-2">
            ...
            <div class="col-sm-4 col-md-4">
                ...
                <div class="title-divider-small"></div>
                <!-- Description -->
                <p>We do upholstery works for small items like chairs and producing new upholstery beds and small furnitures.</p>
            </div>
