...
if (!empty($page_description)) {
    ...
    $description = 'La Fenice – exkluzív lakástextil';
}

if (!empty($page_keywords)) {
    $keywords = $page_keywords;
} else {
    $keywords = 'exkluzív, lakástextil';
}

if ($index_page) {
    $title = "La Fenice – exkluzív lakástextil";
} else {
    $title = $page_title." | La Fenice – exkluzív lakástextil";
}
?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="<?= URL?>">
                                <!-- Logo Image -->
                                <img src="<?= URL?>/assets/img/logo-header.png" height="65px" alt="La Fenice">
                            </a>
                        </div>
                    </div>
